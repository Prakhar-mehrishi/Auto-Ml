...
st.set_page_config(page_title='The Auto Machine Learning App',
                   layout='wide')
...
with st.sidebar.header('1. Upload your CSV data'):
    ...
    st.sidebar.markdown("""
[Example CSV input file](https://github.com/Prakhar-mehrishi/Auto-Ml/blob/main/delaney_solubility_with_descriptors.csv)
""")
